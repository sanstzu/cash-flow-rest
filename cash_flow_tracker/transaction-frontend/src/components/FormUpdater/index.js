...
export default function FormUpdater(props) {

    const [formType,setFormType] = React.useState('PUT');
    const [tempValue, setTempValue] = React.useState(props.val);
    ...
    function create(){
        axios.put(`${API_URL}${tempValue.pk}`, tempValue).then(() => {
